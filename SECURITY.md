...
Report security issues via GitHub Security Advisories at:
<https://github.com/phenotype/pheno-tracing/security/advisories/new>
...
The `pheno-tracing` crate is a substrate library. Security issues may include:
...
Not yet established. Use the GitHub Security Advisory mechanism above for now.
